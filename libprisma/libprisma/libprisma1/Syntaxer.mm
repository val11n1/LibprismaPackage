...
NSDictionary<NSString *, UIColor *> *light = @{
  ...
  @"punctuation": color(0x000000, 1.0),
  @"property": color(0x990055, 1.0),
  @"tag": color(0x990055, 1.0),
  @"boolean": color(0x9B2393, 1.0),
  ...
  @"string": color(0xC41A16, 1.0),
  @"char": color(0xC41A16, 1.0),
  @"builtin": color(0x669900, 1.0),
  @"inserted": color(0x669900, 1.0),
  @"operator": color(0x000000, 1.0),
  @"entity": color(0x9AAE6C, 1.0),
  @"url": color(0x9AAE6C, 1.0),
  @"atrule": color(0x0077AA, 1.0),
  @"attr-value": color(0x0077AA, 1.0),
  @"keyword": color(0x9B2393, 1.0),
  @"function-definition": color(0x0077AA, 1.0),
  @"class-name": color(0x034fad, 1.0),
};

NSDictionary<NSString *, UIColor *> *dark = @{
  @"comment": color(0x7CB554, 1.0),
  @"block-comment": color(0x7CB554, 1.0),
  @"prolog": color(0x7CB554, 1.0),
  @"doctype": color(0x7CB554, 1.0),
  @"cdata": color(0x7CB554, 1.0),
  @"punctuation": color(0xcccccc, 1.0),
  @"property": color(0x72BFAE, 1.0),
  @"tag": color(0xe2777a, 1.0),
  @"boolean": color(0xFC6BAA, 1.0),
  @"number": color(0xD0BC56, 1.0),
  @"constant": color(0xD0BC56, 1.0),
  @"symbol": color(0xD0BC56, 1.0),
  @"deleted": color(0xe2777a, 1.0),
  @"selector": color(0xAA0D91, 1.0),
  @"attr-name": color(0xFC7467, 1.0),
  @"string": color(0xFC7467, 1.0),
  @"char": color(0xFC7467, 1.0),
  @"builtin": color(0xFC7467, 1.0),
  @"inserted": color(0xFC7467, 1.0),
  @"operator": color(0x739AFF, 1.0),
  @"entity": color(0x739AFF, 1.0),
  @"url": color(0x739AFF, 1.0),
  @"atrule": color(0xFC6BAA, 1.0),
  @"attr-value": color(0xFC6BAA, 1.0),
  @"keyword": color(0xFC6BAA, 1.0),
  @"function-definition": color(0x72BFAE, 1.0),
  @"class-name": color(0xA4FBE6, 1.0),
};
...
//        NSString *path = [[[[NSBundle bundleForClass:[self class]] bundlePath] stringByAppendingPathComponent:@"LibprismaBundle.bundle"] stringByAppendingPathComponent:@"grammars.dat"];
        NSString *path = [[NSBundle bundleForClass:[self class]] pathForResource:@"grammars" ofType:@"dat"];
...
- (NSString *)languageNameWith:(NSString *)lang {
  std::string language = _m_highlighter->languageName([lang UTF8String]);
  return [NSString stringWithCString:language.c_str() encoding:[NSString defaultCStringEncoding]];
}
